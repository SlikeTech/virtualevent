var PageRenderer = function(){
	...
	var getComponents = function(_o){
		...
		for(var i=0; i<_o.componants.length; i++){
			if(_o.componants[i].type == "hotspot" || _o.componants[i].type == "video" || _o.componants[i].type === "help_box" || _o.componants[i].type === "text" ||  _o.componants[i].type === "banner"){
				...
				console.log("====", _o.componants[i].title)
				if(tp === "left"){
	...
	var svgIcons = function(icon){
		...
		switch(icon){
			...
			case "Briefcase":
			return str = '<svg xmlns="http://www.w3.org/2000/svg" width="21.691" height="18.98" viewBox="0 0 21.691 18.98"><defs><style>.a{fill:#B2B2B2;}</style></defs><path class="a" d="M13.557,15.129a.678.678,0,0,1-.678.678H8.812a.678.678,0,0,1-.678-.678V13.1H0v6.1A2.085,2.085,0,0,0,2.034,21.23H19.658A2.085,2.085,0,0,0,21.691,19.2V13.1H13.557Zm6.1-8.812H16.269V4.284A2.085,2.085,0,0,0,14.235,2.25H7.456A2.085,2.085,0,0,0,5.423,4.284V6.317H2.034A2.085,2.085,0,0,0,0,8.351V11.74H21.691V8.351A2.085,2.085,0,0,0,19.658,6.317Zm-6.1,0H8.134V4.961h5.423Z" transform="translate(0 -2.25)"></path></svg>'

			case "Poll":
			case "Feedback":
			return str = '<svg xmlns="http://www.w3.org/2000/svg" width="22.46" height="22.46" viewBox="0 0 22.46 22.46"><defs><style>.a{fill:#c9c9c9;}</style></defs><path class="a" d="M23.214,3H5.246A2.243,2.243,0,0,0,3.011,5.246L3,25.46l4.492-4.492H23.214a2.253,2.253,0,0,0,2.246-2.246V5.246A2.253,2.253,0,0,0,23.214,3ZM15.353,16.476H13.107V14.23h2.246Zm0-4.492H13.107V7.492h2.246Z" transform="translate(-3 -3)"></path></svg> '

			case "Playlist":
			return str = '<svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 16 16" width="20" style="margin-top: -6px;"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M4 10h12v2H4zm0-4h12v2H4zm0 8h8v2H4zm10 0v6l5-3z"></path></svg> '
